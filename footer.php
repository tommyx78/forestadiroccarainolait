...
<footer id="footer">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="footer-info">
            <h3>Foresta di Roccarainola</h3>
            <p class="pb-3"><em>Una Natura che conduce in una dimensione senza spazio e senza tempo.</em></p>
            <p>
  ...
  <div class="container">
    <div class="copyright">
      <strong><span>www.forestadiroccarainola.it</span></strong>
    </div>
    <div class="credits">
...
</footer><!-- End Footer Designed by <a href="https://bootstrapmade.com/">BootstrapMade</a> -->
